...
class TestOrdersFeed:
    ...
    def test_total_orders_counter_increases_after_order(self, login, driver):
    ...
    def test_today_orders_counter_increases_after_order(self, login, driver):
    ...
    def test_created_order_appears_in_work(self, login, driver):
